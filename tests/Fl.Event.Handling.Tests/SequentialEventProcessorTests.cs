...
public class SequentialEventProcessorTests
{
    [Test]
    public async Task ProcessAsync_WhenNoHandlers_ShouldReturnUnit()
    {
        var sut = new SequentialEventProcessor<TestPayload>([]);
    ...
    public async Task ProcessAsync_WhenHandlerReturnsLeft_ShouldReturnError()
    {
        ...
        var sut = new SequentialEventProcessor<TestPayload>([handler]);
    ...
    public async Task ProcessAsync_WhenMultipleHandlers_ShouldReturnUnit()
    {
        ...
        var sut = new SequentialEventProcessor<TestPayload>([handler1, handler2]);
